...
!MESSAGE 
!MESSAGE NMAKE /f "aisparser.mak" CFG="example - Win32 Release"
!MESSAGE 
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib "$(PYTHON_LIB)" /nologo /dll /machine:I386 /out:"_aisparser.pyd"
...
ProjDir=.
InputPath=.\aisparser.i
InputName=aisparser

"$(ProjDir)\$(InputName)_wrap.c" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	c:\swig\swig.exe -python -o $(ProjDir)\$(InputName)_wrap.c $(InputPath)
